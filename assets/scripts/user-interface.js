...
/* harmony import */ var _sessions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../sessions */ "./resources/scripts/user-interface/sessions.js");
...
var allNotAdminRoleKeys = registeredRolesKeys.filter(function (v) {
...
var updateQueryAtom = (0,jotai__WEBPACK_IMPORTED_MODULE_5__.atom)(null);
var queryAtom = (0,jotai__WEBPACK_IMPORTED_MODULE_5__.atom)(
/**
 * Initial
 */
function (get) {
...
function (get, set, update) {
  ...
  var middleware = function middleware() {
    return update.reduce(function (carry, _ref, i) {
      var roles = _ref.roles,
          components = _ref.components;
      var immutableConfigArray = Object.entries(components).reduce(function (c, _ref2) {
      ...
      carry[i] = {
        roles: roles,
        components: immutableConfigArray
      };
      return carry;
    }, []);
  };

  var transformedUpdate = middleware();
  /**
   * If the array is empty, fallback to `initQuery`.
   */

  var safeTransformedUpdate = transformedUpdate.length === 0 ? initQuery : transformedUpdate;
  ...
  var deepClone = JSON.parse(JSON.stringify(transformedUpdate));
...
var updateDataAtom = (0,jotai__WEBPACK_IMPORTED_MODULE_5__.atom)(null);
var dataAtom = (0,jotai__WEBPACK_IMPORTED_MODULE_5__.atom)(
/**
 * Read
 *
 * @param {function} get
...
var updateSelectedIndexAtom = (0,jotai__WEBPACK_IMPORTED_MODULE_5__.atom)(null);
var selectedIndexAtom = (0,jotai__WEBPACK_IMPORTED_MODULE_5__.atom)(
/**
 * Initial
 */
function (get) {
  var query = get(queryAtom);
  var session = (0,_sessions__WEBPACK_IMPORTED_MODULE_4__.adminSelectedIndexSession)();
  var isInit = get(updateSelectedIndexAtom) === null;
  var init = isInit && session < query.length ? session : 0;
 ...
 */
function (get, set, update) {
  (0,_sessions__WEBPACK_IMPORTED_MODULE_4__.adminSelectedIndexSession)(update);
...
var updatePathAtom = (0,jotai__WEBPACK_IMPORTED_MODULE_5__.atom)(null);
var pathAtom = (0,jotai__WEBPACK_IMPORTED_MODULE_5__.atom)(
/**
 * Read
 *
 * @param {function} get
...
function (get) {
  ...
  var session = (0,_sessions__WEBPACK_IMPORTED_MODULE_4__.adminPathSession)();
...
function (get, set, update) {
  ...
  set(updatePathAtom, (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__.default)(updatePath));
  (0,_sessions__WEBPACK_IMPORTED_MODULE_4__.adminPathSession)((0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__.default)(updatePath));
});
/**
 * Diff: Is Blocking
 *
...
var updateIsBlockingAtom = (0,jotai__WEBPACK_IMPORTED_MODULE_5__.atom)(null);
var isBlockingAtom = (0,jotai__WEBPACK_IMPORTED_MODULE_5__.atom)(
/**
 * Read
 *
 * @param {function} get
...
var selectedIndexDataAtom = (0,jotai__WEBPACK_IMPORTED_MODULE_5__.atom)(
/**
 * Read
 *
 * @param {function} get
...
var selectedIndexDataComponentAtom = (0,jotai__WEBPACK_IMPORTED_MODULE_5__.atom)(
/**
 * Initial
 */
null,
 ...
 */
function (get, set, update) {
  var _update = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(update, 3),
      action = _update[0],
      key = _update[1],
      _update$ = _update[2],
...
var getRolesFromAlias = function getRolesFromAlias(roles) {
  if (roles.includes('all')) return registeredRolesKeys;
  if (roles.includes('all-not-administrator')) return allNotAdminRoleKeys;
  return roles;
};

var selectedIndexDataRoleAtom = (0,jotai__WEBPACK_IMPORTED_MODULE_5__.atom)(
/**
 * Initial
 */
null,
...
function (get, set, update) {
  ...
  var _data$selectedIndex$r = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(data[selectedIndex].roles, 1),
      getRoles = _data$selectedIndex$r[0];

  var roles = getRolesFromAlias(getRoles);
  /**
   * Actions
   *
   * @description run `add` or `remove` on `selectedIndex`.
  ...
  var add = function add() {
    return [].concat((0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__.default)(roles), [update]);
  };
  ...
  var aliases = function aliases(roles) {
    if (roles.length === registeredRolesKeys.length) {
      return ['all'];
    }

    if (allNotAdminRoleKeys.every(function (v) {
...
var selectedIndexPathAtom = (0,jotai__WEBPACK_IMPORTED_MODULE_5__.atom)(
/**
 * Read
 *
 * @param {funciton} get
...
/* harmony import */ var _Page_Page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Page/Page */ "./resources/scripts/user-interface/interface/Page/Page.js");
/* harmony import */ var _Page_Sidebar__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Page/Sidebar */ "./resources/scripts/user-interface/interface/Page/Sidebar.js");
/* harmony import */ var _Admin_Head__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Admin/Head */ "./resources/scripts/user-interface/interface/Admin/Head.js");
/* harmony import */ var _Admin_Components__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Admin/Components */ "./resources/scripts/user-interface/interface/Admin/Components.js");
/* harmony import */ var _Admin_ComponentsApplied__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Admin/ComponentsApplied */ "./resources/scripts/user-interface/interface/Admin/ComponentsApplied.js");
/* harmony import */ var _queries__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../queries */ "./resources/scripts/user-interface/queries.js");
...
/* harmony import */ var _sessions__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../sessions */ "./resources/scripts/user-interface/sessions.js");
...
var Admin = function Admin() {
   ...
   * Query
   */
  var query = (0,react_query__WEBPACK_IMPORTED_MODULE_2__.useQuery)('admin', _queries__WEBPACK_IMPORTED_MODULE_9__.adminQuery, {
    suspense: true,
  ...
  var session = (0,_sessions__WEBPACK_IMPORTED_MODULE_11__.adminShowSession)();
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
    ...
    */
    setQuery(query.data); // refetch on unmount to ensure query has the latest data
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
    (0,_sessions__WEBPACK_IMPORTED_MODULE_11__.adminShowSession)(show);
  }, [show]);
  /**
   * Render
   */

  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Page_Page__WEBPACK_IMPORTED_MODULE_4__.Page, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Page_Sidebar__WEBPACK_IMPORTED_MODULE_5__.Sidebar, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Page_Sidebar__WEBPACK_IMPORTED_MODULE_5__.SidebarGroup, {
  ...
  }, query.isSuccess && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Admin_Head__WEBPACK_IMPORTED_MODULE_6__.Head, null), show === 'all' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Admin_Components__WEBPACK_IMPORTED_MODULE_7__.Components, null), show === 'applied' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Admin_ComponentsApplied__WEBPACK_IMPORTED_MODULE_8__.ComponentsApplied, null))));
};
...
/* harmony import */ var _Components_Breadcrumb__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Components/Breadcrumb */ "./resources/scripts/user-interface/interface/Admin/Components/Breadcrumb.js");
...
/* harmony import */ var _Components_TextItem__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Components/TextItem */ "./resources/scripts/user-interface/interface/Admin/Components/TextItem.js");
/* harmony import */ var _Components_NumberItem__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Components/NumberItem */ "./resources/scripts/user-interface/interface/Admin/Components/NumberItem.js");
/* harmony import */ var _Components_IconItem__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Components/IconItem */ "./resources/scripts/user-interface/interface/Admin/Components/IconItem.js");
/* harmony import */ var _Components_RouteItem__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Components/RouteItem */ "./resources/scripts/user-interface/interface/Admin/Components/RouteItem.js");
/* harmony import */ var _Components_SelectItem__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Components/SelectItem */ "./resources/scripts/user-interface/interface/Admin/Components/SelectItem.js");
/* harmony import */ var _Components_BooleanGroup__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Components/BooleanGroup */ "./resources/scripts/user-interface/interface/Admin/Components/BooleanGroup.js");
...
var Components = function Components() {
  ...
  var Routing = function Routing(_ref) {
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, (0,_Components_HierachicalItem__WEBPACK_IMPORTED_MODULE_3__.isHierachical)(k) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Components_HierachicalItem__WEBPACK_IMPORTED_MODULE_3__.Hierachical, {
      item: key
    }), (0,_Components_BooleanItem__WEBPACK_IMPORTED_MODULE_4__.isBooleanItem)(k) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Components_BooleanItem__WEBPACK_IMPORTED_MODULE_4__.BooleanItem, {
      item: key
    }), (0,_Components_TextItem__WEBPACK_IMPORTED_MODULE_5__.isTextItem)(k) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Components_TextItem__WEBPACK_IMPORTED_MODULE_5__.TextItem, {
      item: key
    }), (0,_Components_NumberItem__WEBPACK_IMPORTED_MODULE_6__.isNumberItem)(k) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Components_NumberItem__WEBPACK_IMPORTED_MODULE_6__.NumberItem, {
      item: key
    }), (0,_Components_IconItem__WEBPACK_IMPORTED_MODULE_7__.isIconItem)(k) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Components_IconItem__WEBPACK_IMPORTED_MODULE_7__.IconItem, {
      item: key
    }), (0,_Components_SelectItem__WEBPACK_IMPORTED_MODULE_9__.isSelectItem)(k) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Components_SelectItem__WEBPACK_IMPORTED_MODULE_9__.SelectItem, {
      item: key,
      staticData: getStaticComponentsData(key)
    }), (0,_Components_BooleanGroup__WEBPACK_IMPORTED_MODULE_10__.isBooleanGroup)(k) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Components_BooleanGroup__WEBPACK_IMPORTED_MODULE_10__.BooleanGroup, {
      item: key,
      staticData: getStaticComponentsData(key)
    }));
  };
  ...
  var RouteItemGroup = function RouteItemGroup() {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Components_RouteItem__WEBPACK_IMPORTED_MODULE_8__.RouteItem, {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Components_Breadcrumb__WEBPACK_IMPORTED_MODULE_2__.Breadcrumb, null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    className: "border-gray-2 border-b mb-[-1px]"
  }, (0,_Components_RouteItem__WEBPACK_IMPORTED_MODULE_8__.isRouteItem)(getFirstPathKey) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(RouteItemGroup, null), !(0,_Components_RouteItem__WEBPACK_IMPORTED_MODULE_8__.isRouteItem)(getFirstPathKey) && Object.keys(getStaticComponentsData(path)).map(function (key) {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(Routing, {
      key: key,
      item: key
    });
...
var ParentItem = function ParentItem(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_4__.Row, {
    immutable: immutable,
    isButton: true
  ...
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_4__.RowIn, null, interventionKey)));
};
/**
 * Child Item
 *
...
var ChildItem = function ChildItem(_ref2) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_4__.Row, {
    ...
    state: state
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_4__.RowIn, null, key)));
};
/**
 * Boolean Group
 *
...
var BooleanGroup = function BooleanGroup(_ref3) {
  ...
  var firstRender = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useRef)(true);
  /**
   * State: Selected
   */
  ...
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_4__.RowInset, null, childData.map(function (k) {
...
var BooleanItem = function BooleanItem(_ref) {
  ...
  var _useAtom = (0,jotai__WEBPACK_IMPORTED_MODULE_7__.useAtom)(_atoms_admin__WEBPACK_IMPORTED_MODULE_4__.selectedIndexDataComponentAtom),
      _useAtom2 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__.default)(_useAtom, 2),
      setComponent = _useAtom2[1];

  var _useAtom3 = (0,jotai__WEBPACK_IMPORTED_MODULE_7__.useAtom)(_atoms_admin__WEBPACK_IMPORTED_MODULE_4__.selectedIndexDataAtom),
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_3__.Row, {
    ...
    state: state
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_3__.RowIn, null, (0,_utils_admin__WEBPACK_IMPORTED_MODULE_5__.getInterventionKey)(key))));
};
...
var Breadcrumb = function Breadcrumb() {
  var _useAtom = (0,jotai__WEBPACK_IMPORTED_MODULE_6__.useAtom)(_atoms_admin__WEBPACK_IMPORTED_MODULE_3__.pathAtom),
      _useAtom2 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__.default)(_useAtom, 2),
      setPath = _useAtom2[1];

  var _useAtom3 = (0,jotai__WEBPACK_IMPORTED_MODULE_6__.useAtom)(_atoms_admin__WEBPACK_IMPORTED_MODULE_3__.selectedIndexPathAtom),
      _useAtom4 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__.default)(_useAtom3, 1),
      path = _useAtom4[0];
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    className: " relative w-full h-[50px] flex border-b border-gray-5 pl-16"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    className: "flex border-r border-gray-2"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    className: " h-full flex items-center pr-[8px]"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
    className: "text-14  is-blank",
    onClick: function onClick() {
      return handler('');
    }
  }, (0,_utils_wp__WEBPACK_IMPORTED_MODULE_5__.__)('admin'))), isPath() && paths.map(function (item) {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
      key: item,
      className: "relative pr-[8px] pl-[10px]"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
...
var isHierachical = function isHierachical(k) {
  return k.includes(':hierachical'); // return (k.match(/:hierachical/g) || []).length === 1;
};
/**
 * Hierachical Applied
 *
...
var HierachicalApplied = function HierachicalApplied(_ref) {
  var count = _ref.count;
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, count !== 0 && count !== null && count !== undefined && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    className: " min-w-[48px] h-full flex items-center justify-center text-14 text-primary-10 leading-none border-l border-gray-2"
  }, count));
};
/*
min-w-[22px]
...
var Hierachical = function Hierachical(_ref2) {
  var key = _ref2.item;

  var _useAtom = (0,jotai__WEBPACK_IMPORTED_MODULE_6__.useAtom)(_atoms_admin__WEBPACK_IMPORTED_MODULE_4__.pathAtom),
      _useAtom2 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__.default)(_useAtom, 2),
      setPath = _useAtom2[1];

  var _useAtom3 = (0,jotai__WEBPACK_IMPORTED_MODULE_6__.useAtom)(_atoms_admin__WEBPACK_IMPORTED_MODULE_4__.selectedIndexDataAtom),
      _useAtom4 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__.default)(_useAtom3, 1),
      data = _useAtom4[0];
  /**
   * Get Applied Count
  ...
  var getAppliedCount = function getAppliedCount() {
    var components = Object.keys(data.components);

    if (components.length) {
      var componentsForKey = components.filter(function (k) {
        return k.startsWith((0,_utils_admin__WEBPACK_IMPORTED_MODULE_5__.getInterventionKey)(key));
      });
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_3__.RowIn, {
    isHierachical: true
  }, (0,_utils_admin__WEBPACK_IMPORTED_MODULE_5__.getInterventionKey)(key)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(HierachicalApplied, {
...
var IconItem = function IconItem(_ref) {
  ...
  var _useAtom3 = (0,jotai__WEBPACK_IMPORTED_MODULE_8__.useAtom)(_atoms_admin__WEBPACK_IMPORTED_MODULE_5__.selectedIndexDataComponentAtom),
  ...
  var handler = function handler(value) {
    value !== '' ? setComponent(['add', interventionKey, value]) : setComponent(['del', interventionKey]);
    setState(value);
  };
  /**
   * Render
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_4__.Row, {
    item: key,
    immutable: immutable
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_4__.RowState, {
    state: state
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_4__.RowKey, null, interventionKey), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_4__.RowValue, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.CustomSelectControl, {
    label: "Route",
  ...
  }), immutable === false && state !== '' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_4__.RowValueUndo, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Button, {
    className: "is-secondary",
    onClick: function onClick() {
      return handler('');
    }
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_4__.RowValueUndoIn, null))))));
};
...
var RouteItem = function RouteItem(_ref) {
  ...
  var handler = function handler(selected) {
    var value = selected !== '' ? selected.selectedItem.value : '';
    value !== '' ? setComponent(['add', interventionKey, value]) : setComponent(['del', interventionKey]);
    setState(value);
  };
  /**
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_4__.RowValueUndoIn, null))))), state === '' && children);
};
...
/* harmony export */   "RowIn": () => (/* binding */ RowIn),
/* harmony export */   "RowInset": () => (/* binding */ RowInset),
/* harmony export */   "RowKey": () => (/* binding */ RowKey),
/* harmony export */   "RowValue": () => (/* binding */ RowValue),
/* harmony export */   "RowValueUndo": () => (/* binding */ RowValueUndo),
/* harmony export */   "RowValueUndoIn": () => (/* binding */ RowValueUndoIn),
...
/* harmony import */ var _Page_PseudoFade__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../Page/PseudoFade */ "./resources/scripts/user-interface/interface/Page/PseudoFade.js");
...
var Row = function Row(_ref) {
  ...
  var disabled = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Disabled, {
    className: "w-full flex"
  }, children);
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "\n        row\n        relative\n        min-h-[44px]\n        px-1\n        flex-1\n        flex\n        text-14\n        text-gray-50\n        leading-none\n        border-t\n        border-gray-2\n        first:border-0\n        ".concat(isButton ? 'focus-within:text-primary-10 row-button' : '', "\n      ")
  }, immutable ? disabled : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, children));
};
/**
 * Row In
 *
...
var RowIn = function RowIn(_ref2) {
  var children = _ref2.children,
      _ref2$isHierachical = _ref2.isHierachical,
      isHierachical = _ref2$isHierachical === void 0 ? false : _ref2$isHierachical;
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: " relative w-full h-full truncate"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "\n          absolute\n          inset-0\n          pr-8\n          flex\n          items-center\n          ".concat(isHierachical ? 'pl-16' : 'pl-8', "\n        ")
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "leading-none"
  }, children), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Page_PseudoFade__WEBPACK_IMPORTED_MODULE_2__.PseudoFade, null)));
};
/**
 * Row Key
 *
...
var RowKey = function RowKey(_ref3) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: " relative w-[35%] h-[44px] px-8 pt-1 flex items-center truncate lg:w-1/2"
  }, children, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Page_PseudoFade__WEBPACK_IMPORTED_MODULE_2__.PseudoFade, null));
};
/**
 * Row Inset
...
var RowInset = function RowInset(_ref4) {
  var children = _ref4.children;
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "ml-48 border-l border-t border-gray-2"
  }, children);
};
/**
 * Row Value
...
var RowValue = function RowValue(_ref5) {
  var children = _ref5.children;
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: " row-value relative flex-1 px-12 flex items-center border-l border-gray-2"
  }, children);
};
/**
 * Row Value Undo
...
var RowValueUndo = function RowValueUndo(_ref6) {
  var children = _ref6.children;
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "pl-6 h-[44px] flex items-center self-start"
  }, children);
};
/**
 * Row Value Undo In
...
var RowValueUndoIn = function RowValueUndoIn() {
  ...
  }, (0,_utils_wp__WEBPACK_IMPORTED_MODULE_3__.__)('Undo')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Icon, {
    className: " w-12 flex items-center justify-center text-16 lg:hidden ",
    icon: "undo"
  }));
};
/**
...
var RowState = function RowState(_ref7) {
  var _ref7$state = _ref7.state,
      state = _ref7$state === void 0 ? false : _ref7$state;
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Disabled.Consumer, null, function (isDisabled) {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: " min-w-[48px] border-r border-gray-2 z-0"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "h-[44px] flex items-center justify-center"
    }, !isDisabled && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, removed() && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Icon, {
      icon: "saved"
    }), edited() && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Icon, {
      icon: "editor-textcolor"
    })), isDisabled && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.Icon, {
      icon: "editor-code"
    })));
  });
};
...
/***/ "./resources/scripts/user-interface/interface/Admin/Components/SelectItem.js":
/*!***********************************************************************************!*\
  !*** ./resources/scripts/user-interface/interface/Admin/Components/SelectItem.js ***!
  \***********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var isSelectItem = function isSelectItem(k) {
...
var SelectItem = function SelectItem(_ref) {
  ...
  var staticDataKeys = Object.keys(staticData);
  /**
  ...
  var getImmutableOption = function getImmutableOption(value) {
    var name = (0,_utils_admin__WEBPACK_IMPORTED_MODULE_5__.getCustomSelectOptionName)(value);
    return [{
      key: value,
      name: name,
      value: value
  ...
  var options = immutable ? getImmutableOption(state) : (0,_utils_admin__WEBPACK_IMPORTED_MODULE_5__.getCustomSelectOptionsArray)(staticDataKeys);
  /**
   * Handler
   *
   * @param {string} value
  ...
  var Select = function Select() {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.CustomSelectControl, {
      className: "row",
      hideLabelFromVision: true,
      value: options.find(function (option) {
        return option.value === state;
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_3__.Row, {
    ...
    state: state
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_3__.RowKey, null, interventionKey), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_3__.RowValue, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(Select, null), immutable === false && state !== '' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_3__.RowValueUndo, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_3__.RowValueUndoIn, null))));
};
...
var TextItem = function TextItem(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_3__.Row, {
    ...
    state: state
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_3__.RowKey, null, interventionKey), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_3__.RowValue, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.TextControl, {
    label: false,
  ...
  }), immutable === false && state !== '' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_3__.RowValueUndo, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
    className: "is-secondary",
    onClick: function onClick() {
      return handler('');
    }
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Row__WEBPACK_IMPORTED_MODULE_3__.RowValueUndoIn, null)))));
};
...
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var jotai__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! jotai */ "./node_modules/jotai/esm/index.js");
/* harmony import */ var _Components_HierachicalItem__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Components/HierachicalItem */ "./resources/scripts/user-interface/interface/Admin/Components/HierachicalItem.js");
/* harmony import */ var _Components_BooleanItem__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Components/BooleanItem */ "./resources/scripts/user-interface/interface/Admin/Components/BooleanItem.js");
/* harmony import */ var _Components_BooleanGroup__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Components/BooleanGroup */ "./resources/scripts/user-interface/interface/Admin/Components/BooleanGroup.js");
/* harmony import */ var _Components_TextItem__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Components/TextItem */ "./resources/scripts/user-interface/interface/Admin/Components/TextItem.js");
/* harmony import */ var _Components_NumberItem__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Components/NumberItem */ "./resources/scripts/user-interface/interface/Admin/Components/NumberItem.js");
/* harmony import */ var _Components_IconItem__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Components/IconItem */ "./resources/scripts/user-interface/interface/Admin/Components/IconItem.js");
/* harmony import */ var _Components_RouteItem__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Components/RouteItem */ "./resources/scripts/user-interface/interface/Admin/Components/RouteItem.js");
...
var isAppliedNotFound = function isAppliedNotFound() {
...
var AppliedNotFound = function AppliedNotFound(_ref) {
  var children = _ref.children;
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("h2", {
    className: " text-16 m-0 h-[50px] flex items-center px-16 text-gray-50 font-400 border-t border-gray-2"
  }, children);
};
/**
 * Components Applied
...
var ComponentsApplied = function ComponentsApplied() {
   ...
   * @returns
   */
  var RoutingHierachical = function RoutingHierachical(_ref2) {
    var item = _ref2.item;
    var interventionKey = (0,_utils_admin__WEBPACK_IMPORTED_MODULE_10__.getInterventionKey)(item);
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, isHierachicalTitle(interventionKey) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("h2", {
      className: " text-16 m-0 h-[50px] flex items-center px-16 text-gray-50 font-400 border-t border-gray-2"
    }, interventionKey), Object.keys(getStaticComponentsData(item)).map(function (key) {
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(Routing, {
        key: key,
        item: key,
        path: item
  ...
  var RoutingBooleanGroup = function RoutingBooleanGroup(_ref3) {
    var groupKey = _ref3.item;
  ...
  var Routing = function Routing(_ref4) {
    var k = _ref4.item,
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, (0,_Components_HierachicalItem__WEBPACK_IMPORTED_MODULE_2__.isHierachical)(k) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(RoutingHierachical, {
      item: key
    }), isItemOn(key) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, (0,_Components_BooleanItem__WEBPACK_IMPORTED_MODULE_3__.isBooleanItem)(k) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Components_BooleanItem__WEBPACK_IMPORTED_MODULE_3__.BooleanItem, {
      item: key
    }), (0,_Components_TextItem__WEBPACK_IMPORTED_MODULE_5__.isTextItem)(k) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Components_TextItem__WEBPACK_IMPORTED_MODULE_5__.TextItem, {
      item: key
    }), (0,_Components_NumberItem__WEBPACK_IMPORTED_MODULE_6__.isNumberItem)(k) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Components_NumberItem__WEBPACK_IMPORTED_MODULE_6__.NumberItem, {
      ...
      item: key
    }), (0,_Components_BooleanGroup__WEBPACK_IMPORTED_MODULE_4__.isBooleanGroup)(k) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Components_BooleanItem__WEBPACK_IMPORTED_MODULE_3__.BooleanItem, {
      item: key
    }), (0,_Components_RouteItem__WEBPACK_IMPORTED_MODULE_8__.isRouteItem)(k) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Components_RouteItem__WEBPACK_IMPORTED_MODULE_8__.RouteItem, {
      item: key
    })), (0,_Components_BooleanGroup__WEBPACK_IMPORTED_MODULE_4__.isBooleanGroup)(k) && !isItemOn(key) && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(RoutingBooleanGroup, {
      item: key
    }));
  };
  /**
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    className: "border-gray-2 border-b mt-[-1px] mb-[-1px]"
  }, isAppliedNotFound() && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(AppliedNotFound, null, (0,_utils_wp__WEBPACK_IMPORTED_MODULE_12__.__)('Nothing found'), "."), Object.keys(getStaticComponentsData()).map(function (key) {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(Routing, {
      key: key,
      item: key
    });
...
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/components */ "@wordpress/components");
/* harmony import */ var _wordpress_components__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _Page_Toolbar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../Page/Toolbar */ "./resources/scripts/user-interface/interface/Page/Toolbar.js");
/* harmony import */ var _RoleGroups_RoleGroupDropdown__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./RoleGroups/RoleGroupDropdown */ "./resources/scripts/user-interface/interface/Admin/RoleGroups/RoleGroupDropdown.js");
/* harmony import */ var _RoleGroups_EditRoleGroup__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./RoleGroups/EditRoleGroup */ "./resources/scripts/user-interface/interface/Admin/RoleGroups/EditRoleGroup.js");
/* harmony import */ var _RoleGroups_NewRoleGroup__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./RoleGroups/NewRoleGroup */ "./resources/scripts/user-interface/interface/Admin/RoleGroups/NewRoleGroup.js");
/* harmony import */ var _RoleGroups_DeleteRoleGroup__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./RoleGroups/DeleteRoleGroup */ "./resources/scripts/user-interface/interface/Admin/RoleGroups/DeleteRoleGroup.js");
/* harmony import */ var _Save__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Save */ "./resources/scripts/user-interface/interface/Admin/Save.js");
/* harmony import */ var _atoms_admin__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../atoms/admin */ "./resources/scripts/user-interface/atoms/admin.js");
...
var Head = function Head() {
  var _useAtom = (0,jotai__WEBPACK_IMPORTED_MODULE_11__.useAtom)(_atoms_admin__WEBPACK_IMPORTED_MODULE_9__.dataAtom),
      _useAtom2 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__.default)(_useAtom, 1),
      data = _useAtom2[0];

  var _useAtom3 = (0,jotai__WEBPACK_IMPORTED_MODULE_11__.useAtom)(_atoms_admin__WEBPACK_IMPORTED_MODULE_9__.selectedIndexAtom),
      _useAtom4 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__.default)(_useAtom3, 1),
  ...
  var _useState5 = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(false),
      ...
      isNoData = _useState6[0],
      setIsNoData = _useState6[1];
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
    ...
    var state = data.length === 1 && data[0].roles[0][0] === '';
    /*
  ...
  var renderEditing = function renderEditing() {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Page_Toolbar__WEBPACK_IMPORTED_MODULE_3__.Toolbar, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Page_Toolbar__WEBPACK_IMPORTED_MODULE_3__.ToolbarFlex, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    className: "flex items-center"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_RoleGroups_RoleGroupDropdown__WEBPACK_IMPORTED_MODULE_4__.RoleGroupDropdown, {
    stateHead: {
      setIsNew: setIsNew,
      reset: reset,
      isNoData: isNoData
    }
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Page_Toolbar__WEBPACK_IMPORTED_MODULE_3__.ToolbarContent, null, immutable && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    className: " ml-12 mr-8 w-1 h-full bg-gray-5"
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("span", {
    className: "hidden lg:flex text-gray-50 items-center mr-12 text-13"
  }, (0,_utils_wp__WEBPACK_IMPORTED_MODULE_10__.__)('Hardcoded')))))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Page_Toolbar__WEBPACK_IMPORTED_MODULE_3__.ToolbarContent, null, isNoData === false && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, !immutable && !isNew && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
    className: "is-secondary",
    onClick: function onClick() {
      return handler();
    }
  ...
  }, (0,_utils_wp__WEBPACK_IMPORTED_MODULE_10__.__)('Edit')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Icon, {
    className: " flex items-center justify-center text-16 w-12 lg:hidden ",
    icon: "edit"
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    className: "w-8"
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_RoleGroups_NewRoleGroup__WEBPACK_IMPORTED_MODULE_6__.NewRoleGroup, {
    stateHead: {
      setIsNew: setIsNew,
      isNoData: isNoData
    }
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Page_Toolbar__WEBPACK_IMPORTED_MODULE_3__.ToolbarDivider, null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Save__WEBPACK_IMPORTED_MODULE_8__.Save, {
    stateHead: {
      reset: reset
    }
  }))), renderEditing() && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Page_Toolbar__WEBPACK_IMPORTED_MODULE_3__.Toolbar, {
    autoHeight: true
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    className: "w-full h-full flex flex-wrap"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    className: "w-full lg:w-auto flex h-full"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    className: " flex items-center text-14 text-gray-90 font-500"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_RoleGroups_EditRoleGroup__WEBPACK_IMPORTED_MODULE_5__.EditRoleGroup, null)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    className: " hidden lg:block ml-12 mr-8 w-1 h-full bg-gray-2"
  })), isNoData === false && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    className: " h-full flex items-center text-gray-70 text-13 lg:text-14"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_RoleGroups_DeleteRoleGroup__WEBPACK_IMPORTED_MODULE_7__.DeleteRoleGroup, null)))));
};
...
/***/ "./resources/scripts/user-interface/interface/Admin/RoleGroups/EditRoleGroup.js":
/*!**************************************************************************************!*\
  !*** ./resources/scripts/user-interface/interface/Admin/RoleGroups/EditRoleGroup.js ***!
  \**************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "EditRoleGroup": () => (/* binding */ EditRoleGroup)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/slicedToArray */ "./node_modules/@babel/runtime/helpers/esm/slicedToArray.js");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__);
...
var getAliasedRoles = function getAliasedRoles(roles) {
  ...
  var getAllNotAdmin = function getAllNotAdmin() {
    return registeredRolesKeys.filter(function (v) {
      return v !== 'administrator';
    });
  };
...
var EditRoleGroup = function EditRoleGroup() {
  var _useAtom = (0,jotai__WEBPACK_IMPORTED_MODULE_5__.useAtom)(_atoms_admin__WEBPACK_IMPORTED_MODULE_3__.selectedIndexDataAtom),
      _useAtom2 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__.default)(_useAtom, 1),
      data = _useAtom2[0];

  var _useAtom3 = (0,jotai__WEBPACK_IMPORTED_MODULE_5__.useAtom)(_atoms_admin__WEBPACK_IMPORTED_MODULE_3__.selectedIndexDataRoleAtom),
      _useAtom4 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__.default)(_useAtom3, 2),
      setRole = _useAtom4[1];
  ...
  var rolesRender = getAliasedRoles(roles);
  /**
   * Handler
   *
   * @param {string} role
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ButtonGroup, null, registeredRolesKeys.map(function (key) {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
      key: key,
      className: "\n          ".concat(rolesRender.includes(key) ? 'is-active' : '', "\n        "),
      onClick: function onClick() {
        return handler(key);
      }
    }, key);
...
var NewRoleGroup = function NewRoleGroup(_ref) {
  ...
  var _useAtom3 = (0,jotai__WEBPACK_IMPORTED_MODULE_6__.useAtom)(_atoms_admin__WEBPACK_IMPORTED_MODULE_4__.pathAtom),
      _useAtom4 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(_useAtom3, 2),
      setPath = _useAtom4[1];

  var _useAtom5 = (0,jotai__WEBPACK_IMPORTED_MODULE_6__.useAtom)(_atoms_admin__WEBPACK_IMPORTED_MODULE_4__.selectedIndexAtom),
      _useAtom6 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(_useAtom5, 2),
      setSelectedIndex = _useAtom6[1];
  ...
  var addRoleGroup = function addRoleGroup() {
    ...
    var addGroup = stateHead.noData === true ? [template].concat() : [].concat((0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__.default)(data), [template]);
    setData(addGroup);
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Button, {
    ...
    className: "hidden lg:inline"
  }, (0,_utils_wp__WEBPACK_IMPORTED_MODULE_5__.__)('New')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Icon, {
    className: " flex items-center justify-center text-16 w-12 lg:hidden ",
    icon: "plus-alt2"
  }));
};
...
var RoleGroupDropdown = function RoleGroupDropdown(_ref) {
  ...
  var _useAtom3 = (0,jotai__WEBPACK_IMPORTED_MODULE_5__.useAtom)(_atoms_admin__WEBPACK_IMPORTED_MODULE_3__.selectedIndexAtom),
      _useAtom4 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__.default)(_useAtom3, 2),
      selectedIndex = _useAtom4[0],
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, stateHead.isNoData && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Disabled, {
    className: "rolegroup-dropdown-disabled"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(Dropdown, null)), stateHead.isNoData === false && value.name === '' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", {
    className: "rolegroup-dropdown-disabled"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(Dropdown, null)), stateHead.isNoData === false && value.name !== '' && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(Dropdown, null));
};
...
/* harmony export */   "sortRolesKeys": () => (/* binding */ sortRolesKeys)
/* harmony export */ });
...
var sortRolesKeys = function sortRolesKeys(data) {
  var roleKeys = Object.keys(intervention.route.admin.data.roles);
  data.sort(function (a, b) {
    var _a$roles = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(a.roles, 1),
        rolesA = _a$roles[0];

    var _b$roles = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(b.roles, 1),
        rolesB = _b$roles[0];
...
var setRoleKeyOrder = function setRoleKeyOrder(data, findSelectedIndex) {
  /**
   * Order By Role Keys
   */
  ...
  var selectedIndex = selectedIndexFound ? selectedIndexFound : 0;
  return {
    data: data,
...
var isNoMiddlewareData = function isNoMiddlewareData(data) {
...
var Save = function Save(_ref) {
  ...
  var _useAtom = (0,jotai__WEBPACK_IMPORTED_MODULE_9__.useAtom)(_atoms_admin__WEBPACK_IMPORTED_MODULE_6__.queryAtom),
      _useAtom2 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(_useAtom, 2),
      queryData = _useAtom2[0],
      setQuery = _useAtom2[1];

  var _useAtom3 = (0,jotai__WEBPACK_IMPORTED_MODULE_9__.useAtom)(_atoms_admin__WEBPACK_IMPORTED_MODULE_6__.dataAtom),
      _useAtom4 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(_useAtom3, 1),
      data = _useAtom4[0];

  var _useAtom5 = (0,jotai__WEBPACK_IMPORTED_MODULE_9__.useAtom)(_atoms_admin__WEBPACK_IMPORTED_MODULE_6__.selectedIndexAtom),
      _useAtom6 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(_useAtom5, 2),
      dangerousSelectedIndex = _useAtom6[0],
      setSelectedIndex = _useAtom6[1];

  var _useAtom7 = (0,jotai__WEBPACK_IMPORTED_MODULE_9__.useAtom)(_atoms_admin__WEBPACK_IMPORTED_MODULE_6__.pathAtom),
      _useAtom8 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(_useAtom7, 2),
      path = _useAtom8[0],
      setPath = _useAtom8[1];

  var _useAtom9 = (0,jotai__WEBPACK_IMPORTED_MODULE_9__.useAtom)(_atoms_admin__WEBPACK_IMPORTED_MODULE_6__.isBlockingAtom),
      _useAtom10 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(_useAtom9, 1),
      isBlocking = _useAtom10[0];

  var _useState = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)((0,_utils_wp__WEBPACK_IMPORTED_MODULE_8__.__)('Save')),
      _useState2 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(_useState, 2),
  ...
  (0,react_router_dom__WEBPACK_IMPORTED_MODULE_10__.usePrompt)('You have unsaved changes, are you sure you want to leave?', isBlocking);
  /**
   * Middleware
   *
  ...
  var middleware = function middleware() {
    return data.reduce(function (carry, _ref2) {
      ...
      var removeImmutableComponents = Object.entries(components).reduce(function (carry, _ref3) {
        var _ref4 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(_ref3, 2),
            k = _ref4[0],
            _ref4$ = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(_ref4[1], 2),
            value = _ref4$[0],
            immutable = _ref4$[1];
      ...
      var _roles = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(roles, 1),
          rolesArray = _roles[0];

      var rolesString = rolesArray.join('|');

      if ((0,_utils_structures__WEBPACK_IMPORTED_MODULE_7__.objectHasKey)(carry, rolesString)) {
        carry[rolesString] = _objectSpread(_objectSpread({}, carry[rolesString]), removeImmutableComponents);
      } else {
  ...
  var mutation = (0,react_query__WEBPACK_IMPORTED_MODULE_3__.useMutation)(function () {
    ...
    var savedRoleString = data[dangerousSelectedIndex].roles[0].join();
    var savedPath = path[dangerousSelectedIndex];
    var middlewareData = middleware();
    var sanitizedMiddlewareData = isNoMiddlewareData(middlewareData) ? '' : middlewareData; // post to the api with sanitized `middleware` and action `save`.

    return _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_5___default()({
      url: intervention.route.admin.url,
      method: 'POST',
      data: {
        data: sanitizedMiddlewareData,
        save: true
      }
    }) // the order that the atoms are updated matters as some updates require prior values.
    .then(function (res) {
      var sorted = setRoleKeyOrder(res.data, savedRoleString);
  ...
  var handler = function handler() {
    ...
    var emptyRoleGroupFound = function emptyRoleGroupFound() {
      return Object.keys(middleware()).includes('') && Object.keys(middleware()).length > 1;
    };
    /**
...
/* harmony import */ var _Application_ToolbarContentImported__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./Application/ToolbarContentImported */ "./resources/scripts/user-interface/interface/Application/ToolbarContentImported.js");
...
var Application = function Application() {
   ...
   * Query
   */
  var query = (0,react_query__WEBPACK_IMPORTED_MODULE_2__.useQuery)('application', _queries__WEBPACK_IMPORTED_MODULE_12__.applicationQuery, {
    suspense: true
  });
  /**
   * State
  ...
  var session = (0,_sessions__WEBPACK_IMPORTED_MODULE_13__.applicationShowSession)();
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
    (0,_sessions__WEBPACK_IMPORTED_MODULE_13__.applicationShowSession)(show);
  }, [show]);
  /**
   * Show Determination
   *
  ...
  var showDetermination = function showDetermination(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Page_Page__WEBPACK_IMPORTED_MODULE_6__.Page, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Page_Sidebar__WEBPACK_IMPORTED_MODULE_8__.Sidebar, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Page_Sidebar__WEBPACK_IMPORTED_MODULE_8__.SidebarGroup, {
    ...
    className: "w-full flex-1"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Page_Toolbar__WEBPACK_IMPORTED_MODULE_7__.Toolbar, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Page_Toolbar__WEBPACK_IMPORTED_MODULE_7__.ToolbarFlex, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Page_Toolbar__WEBPACK_IMPORTED_MODULE_7__.ToolbarTitle, null, (0,_utils_wp__WEBPACK_IMPORTED_MODULE_11__.__)('Application')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Page_Toolbar__WEBPACK_IMPORTED_MODULE_7__.ToolbarContent, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Application_ToolbarContentImported__WEBPACK_IMPORTED_MODULE_9__.ToolbarContentImported, {
    imported: imported
  }))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Page_Toolbar__WEBPACK_IMPORTED_MODULE_7__.ToolbarContent, null, diff > 0 && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Button, {
    className: "is-secondary",
    onClick: function onClick() {
      return setShow('mismatch');
    }
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.sprintf)((0,_utils_wp__WEBPACK_IMPORTED_MODULE_11__.__)('Mismatch (%s)'), diff)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Page_Toolbar__WEBPACK_IMPORTED_MODULE_7__.ToolbarDivider, null)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Button, {
    className: "is-primary",
    onClick: function onClick() {
      return handler();
    },
    disabled: diff === 0
  }, mutation.isLoading ? (0,_utils_wp__WEBPACK_IMPORTED_MODULE_11__.__)('Importing') : (0,_utils_wp__WEBPACK_IMPORTED_MODULE_11__.__)('Import')))), query.isError && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, (0,_utils_wp__WEBPACK_IMPORTED_MODULE_11__.__)('Sorry, an error has occured'), "."), query.isSuccess && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, data.filter(showDetermination).length === 0 && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Application_Row__WEBPACK_IMPORTED_MODULE_10__.RowNotFound, null, (0,_utils_wp__WEBPACK_IMPORTED_MODULE_11__.__)('Nothing found'), "."), data.filter(showDetermination).map(function (_ref2) {
...
var RowNotFound = function RowNotFound(_ref) {
  var children = _ref.children;
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: " h-[42px] px-16 flex items-center text-14 leading-none text-gray-50 last:border-0"
  }, children);
};
/**
 * Row
...
var Row = function Row(_ref2) {
  var children = _ref2.children;
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: " flex h-[44px] text-14 leading-none text-gray-50 border-b border-gray-2 last:-mb-1"
  }, children);
};
/**
 * Row Key
...
var RowKey = function RowKey(_ref3) {
  var children = _ref3.children;
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: " relative w-1/2 px-[16px] flex items-center truncate"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: " inset-0 absolute flex items-center px-16"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "leading-none"
  }, children), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Page_PseudoFade__WEBPACK_IMPORTED_MODULE_1__.PseudoFade, null)));
};
/**
 * Row Value
 *
...
var RowValue = function RowValue(_ref4) {
  var children = _ref4.children;
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: " relative w-1/2 px-12 border-l border-gray-2 truncate"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: " inset-0 absolute flex items-center px-12"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    className: "leading-none"
  }, children), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Page_PseudoFade__WEBPACK_IMPORTED_MODULE_1__.PseudoFade, null)));
};
...
var RowValueFromTo = function RowValueFromTo(_ref5) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: " px-4 py-[3px] text-primary-10 rounded border border-primary"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
...
/***/ "./resources/scripts/user-interface/interface/Application/ToolbarContentImported.js":
/*!******************************************************************************************!*\
  !*** ./resources/scripts/user-interface/interface/Application/ToolbarContentImported.js ***!
  \******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ToolbarContentImported": () => (/* binding */ ToolbarContentImported)
/* harmony export */ });
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
...
var ToolbarContentImported = function ToolbarContentImported(_ref) {
  ...
  if (imported.skipped.length > 0) {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)((0,_utils_wp__WEBPACK_IMPORTED_MODULE_2__.__)('Imported %1$s and %2$s failed'), imported.completed.length, imported.skipped.length), '.');
  }
  /**
   * Imported
   */
  ...
  if (imported.completed.length > 0) {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.sprintf)((0,_utils_wp__WEBPACK_IMPORTED_MODULE_2__.__)('Imported %s'), imported.completed.length), ".");
  }
  /**
   * Matching
   */
...
/* harmony import */ var _queries__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../queries */ "./resources/scripts/user-interface/queries.js");
/* harmony import */ var _sessions__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../sessions */ "./resources/scripts/user-interface/sessions.js");
/* harmony import */ var _Admin_Save__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./Admin/Save */ "./resources/scripts/user-interface/interface/Admin/Save.js");
/* harmony import */ var _utils_wp__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../utils/wp */ "./resources/scripts/user-interface/utils/wp.js");
...
var staticExports = intervention.route["export"].data; // const staticExportsAdminSorted = sortRolesKeys(staticExports.admin);
...
var stateFactory = function stateFactory(group) {
...
var getKeysEqualToTrue = function getKeysEqualToTrue(group) {
  return Object.entries(group).reduce(function (carry, _ref) {
...
var isAllChecked = function isAllChecked(group) {
...
var Export = function Export() {
   ...
   * Query
   */
  var queryAdminOptions = (0,react_query__WEBPACK_IMPORTED_MODULE_3__.useQuery)('export-admin-options', _queries__WEBPACK_IMPORTED_MODULE_10__.exportAdminOptions, {
    suspense: true
  });
  var query = (0,react_query__WEBPACK_IMPORTED_MODULE_3__.useQuery)('export', _queries__WEBPACK_IMPORTED_MODULE_10__.exportQuery, {
    suspense: true
  });
  var staticExportsAdminSorted = queryAdminOptions.data.length !== 0 ? (0,_Admin_Save__WEBPACK_IMPORTED_MODULE_12__.sortRolesKeys)(queryAdminOptions.data) : [];
  var applicationKeys = Object.keys(stateFactory(staticExports.application));
  var session = (0,_sessions__WEBPACK_IMPORTED_MODULE_11__.exportSelectionSession)() || applicationKeys;
  /**
   * State
   */

  var _useState = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(stateFactory(staticExports.application, session)),
      _useState2 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(_useState, 2),
      application = _useState2[0],
      setApplication = _useState2[1];

  var _useState3 = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(stateFactory(staticExportsAdminSorted, session)),
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useEffect)(function () {
    var selected = [].concat((0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__.default)(getKeysEqualToTrue(application)), (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__.default)(getKeysEqualToTrue(admin)));
    (0,_sessions__WEBPACK_IMPORTED_MODULE_11__.exportSelectionSession)(selected);
    query.refetch();
  }, [application, admin]);
  /**
   * Write
  ...
  var write = function write(group, _ref3) {
    var key = _ref3.key,
        state = _ref3.state;
    return Object.entries(group).reduce(function (carry, _ref4) {
  ...
  var writeAll = function writeAll(group) {
    var state = isAllChecked(group);
    return Object.entries(group).reduce(function (carry, _ref6) {
      var _ref7 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__.default)(_ref6, 1),
          k = _ref7[0];
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_Page_Page__WEBPACK_IMPORTED_MODULE_5__.Page, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_Page_Sidebar__WEBPACK_IMPORTED_MODULE_7__.Sidebar, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_Page_Sidebar__WEBPACK_IMPORTED_MODULE_7__.SidebarGroup, {
    title: (0,_utils_wp__WEBPACK_IMPORTED_MODULE_13__.__)('Application')
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_Page_Sidebar__WEBPACK_IMPORTED_MODULE_7__.SidebarCheckboxFlex, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_Page_Sidebar__WEBPACK_IMPORTED_MODULE_7__.SidebarCheckboxItem, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.CheckboxControl, {
    label: (0,_utils_wp__WEBPACK_IMPORTED_MODULE_13__.__)('Toggle All', 'intervention'),
    checked: !isAllChecked(application),
    onChange: function onChange() {
      return setApplication(writeAll(application));
    }
  })), staticExports.application.map(function (_ref8) {
    var _application$key;
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_Page_Sidebar__WEBPACK_IMPORTED_MODULE_7__.SidebarCheckboxItem, {
      key: key
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.CheckboxControl, {
      label: (0,_utils_wp__WEBPACK_IMPORTED_MODULE_13__.__)(title),
      checked: (_application$key = application[key]) !== null && _application$key !== void 0 ? _application$key : false,
      onChange: function onChange(state) {
        return setApplication(write(application, {
          key: key,
          state: state
        }));
      }
    }));
  }))), staticExportsAdminSorted.length > 0 && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_Page_Sidebar__WEBPACK_IMPORTED_MODULE_7__.SidebarGroup, {
    title: (0,_utils_wp__WEBPACK_IMPORTED_MODULE_13__.__)('Admin')
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_Page_Sidebar__WEBPACK_IMPORTED_MODULE_7__.SidebarCheckboxFlex, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_Page_Sidebar__WEBPACK_IMPORTED_MODULE_7__.SidebarCheckboxItem, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.CheckboxControl, {
    label: (0,_utils_wp__WEBPACK_IMPORTED_MODULE_13__.__)('Toggle All', 'intervention'),
    checked: !isAllChecked(admin),
    onChange: function onChange() {
      return setAdmin(writeAll(admin));
    }
  })), staticExportsAdminSorted.map(function (_ref9) {
    var _admin$key;
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_Page_Sidebar__WEBPACK_IMPORTED_MODULE_7__.SidebarCheckboxItem, {
      ...
      label: (0,_utils_wp__WEBPACK_IMPORTED_MODULE_13__.__)(title),
      checked: (_admin$key = admin[key]) !== null && _admin$key !== void 0 ? _admin$key : false,
      onChange: function onChange(state) {
        return setAdmin(write(admin, {
          key: key,
          state: state
        }));
      }
...
var Head = function Head() {
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Head_Header__WEBPACK_IMPORTED_MODULE_1__.Header, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "w-full md:w-auto flex flex-wrap"
...
var Header = function Header(_ref) {
  var children = _ref.children;
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: " h-[60px] py-0 px-16 flex justify-between z-30 bg-white border-b border-gray-5"
  }, children);
};
...
var Name = function Name(_ref) {
  var children = _ref.children;
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: " flex-1 mr-[18px] flex items-center font-600 text-20 text-gray-90 sm:flex-none"
  }, children);
};
...
var NavLink = function NavLink(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_2__.NavLink, {
    to: to,
    title: children,
    className: "\n        inline-block\n        h-[36px]\n        mx-[2px]\n        mt-2\n        px-4\n        lg:px-[6px]\n        leading-none\n        no-underline\n        text-14\n        text-center\n        rounded\n        border\n        first:ml-0\n        hover:text-primary\n        active:shadow-none\n        focus:shadow-none\n        hover:shadow-none\n        text-bold-hack\n        ".concat(match ? 'font-500 text-primary-10 border-primary-10' : 'font-400 text-gray-70 border-white')
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
...
var Page = function Page(_ref) {
  var children = _ref.children;
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: " bg-white lg:flex-1 flex flex-wrap w-full"
  }, children);
};
...
var PseudoFade = function PseudoFade() {
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: " absolute top-0 bottom-[1px] right-0 w-[40px] bg-gradient-to-r from-transparent to-white"
  });
};
...
var SidebarGroup = function SidebarGroup(_ref2) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Panel, {
    ...
    className: "w-full"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelRow, null, children)));
};
/**
...
/* harmony export */   "ToolbarDivider": () => (/* binding */ ToolbarDivider),
...
var Toolbar = function Toolbar(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "\n        relative\n        sticky\n        top-0\n        md:top-[32px]\n        w-full\n        px-16\n        flex\n        items-center\n        justify-between\n        border-b\n        border-gray-5\n        bg-white\n        ".concat(autoHeight === true ? 'pt-16 pb-12 lg:py-0 lg:h-[50px]' : 'h-[50px] z-10', "\n      ")
  }, children);
};
/**
 * Toolbar Divider
...
var ToolbarDivider = function ToolbarDivider() {
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: " mx-8 w-1 h-full bg-gray-2"
  });
};
/**
 * Toolbar Flex
...
var ToolbarTitle = function ToolbarTitle(_ref3) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: " ml-12 mr-8 w-1 h-full bg-gray-2"
  }));
};
/**
 * Toolbar Content
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "exportAdminOptions": () => (/* reexport safe */ _queries_export__WEBPACK_IMPORTED_MODULE_2__.exportAdminOptions),
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "exportAdminOptions": () => (/* binding */ exportAdminOptions),
...
var exportAdminOptions = /*#__PURE__*/function () {
  var _ref = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().mark(function _callee() {
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function exportAdminOptions() {
    return _ref.apply(this, arguments);
  };
}();
/**
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_2___default()({
              ...
              method: 'POST',
              data: {
                selected: (0,_sessions__WEBPACK_IMPORTED_MODULE_3__.exportSelectionSession)()
              }
            });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "adminSelectedIndexSession": () => (/* reexport safe */ _sessions_admin__WEBPACK_IMPORTED_MODULE_0__.adminSelectedIndexSession),
/* harmony export */   "adminPathSession": () => (/* reexport safe */ _sessions_admin__WEBPACK_IMPORTED_MODULE_0__.adminPathSession),
/* harmony export */   "adminShowSession": () => (/* reexport safe */ _sessions_admin__WEBPACK_IMPORTED_MODULE_0__.adminShowSession),
/* harmony export */   "applicationShowSession": () => (/* reexport safe */ _sessions_application__WEBPACK_IMPORTED_MODULE_1__.applicationShowSession),
/* harmony export */   "exportSelectionSession": () => (/* reexport safe */ _sessions_export__WEBPACK_IMPORTED_MODULE_2__.exportSelectionSession)
/* harmony export */ });
/* harmony import */ var _sessions_admin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sessions/admin */ "./resources/scripts/user-interface/sessions/admin.js");
/* harmony import */ var _sessions_application__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sessions/application */ "./resources/scripts/user-interface/sessions/application.js");
/* harmony import */ var _sessions_export__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sessions/export */ "./resources/scripts/user-interface/sessions/export.js");
...
/***/ "./resources/scripts/user-interface/sessions/admin.js":
/*!************************************************************!*\
  !*** ./resources/scripts/user-interface/sessions/admin.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "adminSelectedIndexSession": () => (/* binding */ adminSelectedIndexSession),
/* harmony export */   "adminPathSession": () => (/* binding */ adminPathSession),
/* harmony export */   "adminShowSession": () => (/* binding */ adminShowSession)
/* harmony export */ });
/**
 ...
 * @returns {null|string}
 */
var adminSelectedIndexSession = function adminSelectedIndexSession() {
...
var adminPathSession = function adminPathSession() {
  var write = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
...
var adminShowSession = function adminShowSession() {
  var write = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
...
/***/ "./resources/scripts/user-interface/sessions/application.js":
/*!******************************************************************!*\
  !*** ./resources/scripts/user-interface/sessions/application.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "applicationShowSession": () => (/* binding */ applicationShowSession)
/* harmony export */ });
/**
 ...
 * @returns {null|string}
 */
var applicationShowSession = function applicationShowSession() {
  var write = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
...
/***/ "./resources/scripts/user-interface/sessions/export.js":
/*!*************************************************************!*\
  !*** ./resources/scripts/user-interface/sessions/export.js ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "getCustomSelectOptionName": () => (/* binding */ getCustomSelectOptionName),
/* harmony export */   "getCustomSelectOptionsArray": () => (/* binding */ getCustomSelectOptionsArray)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/toConsumableArray */ "./node_modules/@babel/runtime/helpers/esm/toConsumableArray.js");
...
var getInterventionKey = function getInterventionKey() {
  ...
  var replace = [':hierachical', ':text', ':number', ':group', ':exemption', ':icon', ':select', ':orderby', '/:route'];
...
var getCustomSelectOptionName = function getCustomSelectOptionName(value) {
  return value.replaceAll('-', ' ').split('.').map(function (str) {
    return str.split(' ').map(function (word) {
      return word[0].toUpperCase() + word.substring(1);
    }).join(' ');
...
var getCustomSelectOptionsArray = function getCustomSelectOptionsArray(array) {
  var config = array.map(function (value) {
    var name = getCustomSelectOptionName(value);
    return {
      key: value,
      name: name,
      value: value
  ...
  return [{
    ...
    name: '',
    value: ''
  }].concat((0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__.default)(config));
};
/**
 * Safe Selected Index
 *
