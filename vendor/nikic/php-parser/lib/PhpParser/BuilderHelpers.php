...
final class BuilderHelpers
{
    ...
    public static function normalizeIdentifier($name) : Identifier
    {
        ...
        throw new \LogicException('Jacoby\\Intervention\\Expected string or instance of Node\\Identifier');
    }
    /**
    ...
    public static function normalizeIdentifierOrExpr($name)
    {
        ...
        throw new \LogicException('Jacoby\\Intervention\\Expected string or instance of Node\\Identifier or Node\\Expr');
    }
    /**
    ...
    public static function normalizeName($name) : Name
    {
        ...
        throw new \LogicException('Jacoby\\Intervention\\Name must be a string or an instance of Node\\Name');
    }
    /**
    ...
    public static function normalizeNameOrExpr($name)
    {
        ...
        if (!\is_string($name) && !$name instanceof Name) {
            throw new \LogicException('Jacoby\\Intervention\\Name must be a string or an instance of Node\\Name or Node\\Expr');
        }
    ...
    public static function normalizeAttribute($attribute) : Node\AttributeGroup
    {
        ...
        if (!$attribute instanceof Node\Attribute) {
            throw new \LogicException('Jacoby\\Intervention\\Attribute must be an instance of PhpParser\\Node\\Attribute or PhpParser\\Node\\AttributeGroup');
        }
