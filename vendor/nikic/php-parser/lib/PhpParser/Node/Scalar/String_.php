...
namespace Jacoby\Intervention\PhpParser\Node\Scalar;
...
class String_ extends Scalar
{
     ...
     */
    public static function parseDocString(string $startToken, string $str, bool $parseUnicodeEscape = \true) : string
    {
