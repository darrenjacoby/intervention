...
namespace Jacoby\Intervention\PhpParser\Lexer;

use Jacoby\Intervention\PhpParser\Error;
use Jacoby\Intervention\PhpParser\ErrorHandler;
use Jacoby\Intervention\PhpParser\Lexer;
use Jacoby\Intervention\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use Jacoby\Intervention\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use Jacoby\Intervention\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use Jacoby\Intervention\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use Jacoby\Intervention\PhpParser\Lexer\TokenEmulator\FlexibleDocStringEmulator;
use Jacoby\Intervention\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use Jacoby\Intervention\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use Jacoby\Intervention\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use Jacoby\Intervention\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use Jacoby\Intervention\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use Jacoby\Intervention\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use Jacoby\Intervention\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use Jacoby\Intervention\PhpParser\Lexer\TokenEmulator\TokenEmulator;
