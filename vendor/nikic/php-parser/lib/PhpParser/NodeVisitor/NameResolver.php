...
namespace Jacoby\Intervention\PhpParser\NodeVisitor;

use Jacoby\Intervention\PhpParser\ErrorHandler;
use Jacoby\Intervention\PhpParser\NameContext;
...
use Jacoby\Intervention\PhpParser\Node\Name\FullyQualified;
use Jacoby\Intervention\PhpParser\Node\Stmt;
use Jacoby\Intervention\PhpParser\NodeVisitorAbstract;
