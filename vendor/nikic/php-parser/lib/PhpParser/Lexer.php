...
class Lexer
{
    ...
    protected function createTokenMap() : array
    {
        ...
        if (\defined('Jacoby\\Intervention\\T_ONUMBER')) {
            $tokenMap[\Jacoby\Intervention\T_ONUMBER] = Tokens::T_DNUMBER;
        }
        // HHVM also has a separate token for the __COMPILER_HALT_OFFSET__ constant
        if (\defined('Jacoby\\Intervention\\T_COMPILER_HALT_OFFSET')) {
            $tokenMap[\Jacoby\Intervention\T_COMPILER_HALT_OFFSET] = Tokens::T_STRING;
        }
