    ...
    private function getObjectVars(object $object, array $path) : array
    {
        ...
        foreach ((array) $object as $name => $value) {
            ...
            if (\array_key_exists($name, $result)) {
                ...
                throw new ExportException('Class "' . $className . '" has overridden private property "' . $name . '". ' . 'This is not supported for exporting objects with __set_state().', $path);
            }
