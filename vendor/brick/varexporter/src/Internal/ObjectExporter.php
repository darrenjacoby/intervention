...
namespace Jacoby\Intervention\Brick\VarExporter\Internal;
...
abstract class ObjectExporter
{
     ...
     * @return bool
     */
    public abstract function supports(\ReflectionObject $reflectionObject) : bool;
    /**
     ...
     */
    public abstract function export(object $object, \ReflectionObject $reflectionObject, array $path, array $parentIds) : array;
    /**
     ...
     * @return string[] The lines of code.
     */
    protected final function getCreateObjectCode(\ReflectionClass $class) : array
    {
     ...
     */
    protected final function wrapInClosure(array $code) : array
    {
        return \array_merge(['(static function() {'], $this->exporter->indent($code), ['})()']);
    }
}
